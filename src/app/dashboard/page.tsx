      ...
      <div className="bg-white border-b shadow-sm sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Founder Community</h1>
              <p className="text-gray-600 mt-1">{users.length} founders building the future</p>
            </div>
            <button
              onClick={() => router.push('/')}
            ...
            {filteredUsers.map((user) => (
              ...
              >
                ...
                <div className="pt-10 px-6 pb-6">
                  ...
                  {/* Demo Score Status */}
                  <div className="mb-3">
                    <div className="inline-flex items-center px-3 py-1.5 rounded-lg text-sm font-semibold bg-blue-500 text-white">
                      {user.challenge_completed_at ? '✅ Challenge Complete' : '⏳ In Progress'}
                    </div>
                  </div>
